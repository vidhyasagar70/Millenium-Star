                            ...
                            {shape_options.slice(0, 12).map((shape) => (
                                ...
                                >
                                    ...
                                    <label
                                        ...
                                        className={` aspect-square cursor-pointer bg-white justify-center transition-all flex flex-col rounded-md  border border-gray-300 items-center hover:border-gray-400hover:bg-gray-100  peer-data-[state=checked]:bg-[#FFF3E7] peer-data-[state=checked]:text-black peer-data-[state=checked]:border-[#FFE7D0] ${
