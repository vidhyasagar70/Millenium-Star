...
interface HighEndTabContentProps {
    highEndDiamonds: any[];
    highEndLoading: boolean;
    highEndTotalCount: number;
    diamondColumns: any[];
    highEndPageCount: number;
    handleHighEndTableStateChange: (state: any) => void;
    highEndPaginationMeta: any;
}

const HighEndTabContent: React.FC<HighEndTabContentProps> = ({
    highEndDiamonds,
    highEndLoading,
    highEndTotalCount,
    diamondColumns,
            ...
            <div className="flex items-center justify-center gap-5 my-10">
                ...
                <div className="w-80 bg-white border-2 border-gray-200 rounded-xl flex flex-col justify-center items-start gap-2 px-7 py-3">
                    ...
                    <h1 className="text-2xl font-semibold">
                        {highEndLoading
                            ? "..."
                            : highEndDiamonds.filter((d) => d.isAvailable)
                                  .length}
                    </h1>
            ...
            <div className="flex h-full min-h-screen overflow-x-auto flex-col">
                <div className="flex flex-col space-y-8">
                    <DataTable
                        ...
                        onStateChange={handleHighEndTableStateChange}
...
export default HighEndTabContent;
