          ...
          <div className="px-2 py-2 bg-gray-100 border-b sticky top-0 z-20 rounded-lg">
            <div className="flex items-center gap-2 justify-between">
              ...
              <Button
                onClick={toggleView}
                size="sm"
                className="bg-white border border-gray-300 text-black rounded-full h-8 w-8 p-0 flex items-center justify-center min-w-0 hover:bg-gray-50"
              >
                {view === "table" ? (
                  <Grid3X3 className="w-4 h-4" />
                ) : (
              ...
              <div className="flex-1 min-w-0 relative">
                <Input
                  ...
                  onChange={(e) => setSearchTerm(e.target.value)}
                  onKeyPress={(e) => e.key === "Enter" && handleSearch()}
                  className="w-full bg-white border-gray-300 rounded-full h-8 text-xs pr-9 pl-3"
                />
                <Button
                  onClick={() => handleSearch()}
                  disabled={loading}
                  size="sm"
                  className="absolute right-1 top-1/2 -translate-y-1/2 rounded-full h-6 w-6 p-0 bg-black hover:bg-gray-800 text-white flex items-center justify-center min-w-0"
                >
              ...
              <div className="flex items-center gap-1.5">
                <Button
                  ...
                  onClick={() => handleReset()}
                  size="sm"
                  className="bg-white border border-gray-300 rounded-full h-8 w-8 p-0 flex items-center justify-center min-w-0 hover:bg-gray-50"
                >
                ...
                {user && (
                  <>
                    <Button
                      ...
                      size="sm"
                      className="bg-black hover:bg-gray-800 text-white rounded-full h-8 px-2 flex items-center gap-1 disabled:opacity-50 min-w-0"
                    >
                      <ShoppingCart className="w-3.5 h-3.5" />
                      {selected.length > 0 && (
                        <span className="text-[10px] font-medium leading-none">{selected.length}</span>
                      )}
                    </Button>
                    ...
                    <Button
                      ...
                      size="sm"
                      className="bg-gray-700 hover:bg-gray-900 text-white rounded-full h-8 px-2 flex items-center gap-1 disabled:opacity-50 min-w-0"
                    >
                ...
                <Button
                  ...
                  size="sm"
                  className={`rounded-full h-8 w-8 p-0 flex items-center justify-center min-w-0 ${
                    mobileFiltersOpen
